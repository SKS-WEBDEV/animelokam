<p align="center">
    <a href="https://github.com/SKS-WEBDEV/animelokam">
        <img 
...
<div align="center">
  ...
  <div>
    <a 
      href="https://github.com/SKS-WEBDEV/animelokam/issues/new?assignees=ghoshRitesh12&labels=bug&template=bug-report.yml"
    > 
      Bug report
    </a>
    ·
    <a 
      href="https://github.com/SKS-WEBDEV/animelokam/issues/new?assignees=ghoshRitesh12&labels=enhancement&template=feature-request.md"
    >
      Feature request
    </a>
  </div>
...
[![codeql](https://github.com/SKS-WEBDEV/animelokam/actions/workflows/codeql-analysis.yml/badge.svg)](https://github.com/SKS-WEBDEV/animelokam/actions/workflows/codeql-analysis.yml)
[![docker-build](https://github.com/SKS-WEBDEV/animelokam/actions/workflows/docker-build.yml/badge.svg)](https://github.com/SKS-WEBDEV/animelokam/actions/workflows/docker-build.yml)
[![test_coverage](https://github.com/SKS-WEBDEV/animelokam/actions/workflows/test.yml/badge.svg)](https://github.com/SKS-WEBDEV/animelokam/actions/workflows/test.yml)
[![GitHub License](https://img.shields.io/github/license/SKS-WEBDEV/animelokam?logo=github&logoColor=%23959da5&labelColor=%23292e34&color=%2331c754)](https://github.com/SKS-WEBDEV/animelokam/blob/main/LICENSE)

</div>

<div align="center">

[![stars](https://img.shields.io/github/stars/SKS-WEBDEV/animelokam?style=social)](https://github.com/SKS-WEBDEV/animelokam/stargazers)
[![forks](https://img.shields.io/github/forks/SKS-WEBDEV/animelokam?style=social)](https://github.com/SKS-WEBDEV/animelokam/network/members)
[![issues](https://img.shields.io/github/issues/SKS-WEBDEV/animelokam?style=social&logo=github)](https://github.com/SKS-WEBDEV/animelokam/issues?q=is%3Aissue+is%3Aopen+)
[![version](https://img.shields.io/github/v/release/SKS-WEBDEV/animelokam?display_name=release&style=social&logo=github)](https://github.com/SKS-WEBDEV/animelokam/releases/latest)
...
1. Clone the repository and move into the directory.
    ...
    ```bash
    git clone https://github.com/SKS-WEBDEV/animelokam.git
    cd aniwatch-api
    ```
...
The Docker image is available at [The GitHub Container Registry](https://github.com/SKS-WEBDEV/animelokam/pkgs/container/aniwatch).
...
More info can be found in the [`.env.example`](https://github.com/SKS-WEBDEV/animelokam/blob/main/.env.example) file, where envs' having a value that is contained within `<` `>` angled brackets, commented out or not, are just examples and should be replaced with relevant ones.
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/SKS-WEBDEV/animelokam)
...
[![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://render.com/deploy?repo=https://github.com/SKS-WEBDEV/animelokam)
...
Pull requests and stars are always welcome. If you encounter any bug or want to add a new feature to this api, consider creating a new [issue](https://github.com/SKS-WEBDEV/animelokam/issues). If you wish to contribute to this project, read the [CONTRIBUTING.md](https://github.com/SKS-WEBDEV/animelokam/blob/main/CONTRIBUTING.md) file.

## <span id="contributors">✨ Contributors</span>

Thanks to the following people for keeping this project alive and relevant.

[![](https://contrib.rocks/image?repo=SKS-WEBDEV/animelokam)](https://github.com/SKS-WEBDEV/animelokam/graphs/contributors)
...
This project is licensed under the [MIT License](https://opensource.org/license/mit/) - see the [LICENSE](https://github.com/SKS-WEBDEV/animelokam/blob/main/LICENSE) file for more details.
...
<img
  id="star-history" 
  src="https://starchart.cc/SKS-WEBDEV/animelokam.svg?variant=adaptive"
  alt=""
/>
